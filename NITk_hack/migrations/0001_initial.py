# Generated by Django 3.2.6 on 2023-12-28 10:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Nitk_hack.company')),
                ('interests', models.ManyToManyField(blank=True, related_name='users', to='Nitk_hack.Interest')),
